...
namespace dllconexion
{
    ...
    {
        private static string db_user = "root";  /* Variables para establecer conexión a la base de datos */
        private static string db_pass = "12345";
        private static string db_srv = "localhost";
        private static string db_name = "reporte2";
